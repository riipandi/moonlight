...
export const Card = ({ title, cta, href }: { title: string; cta: string; href: string }) => {
  return (
    <a
      ...
      href={href}
      className='ui-group ui-mt-4 ui-rounded-lg ui-border ui-border-transparent ui-overflow-hidden ui-bg-origin-border ui-bg-gradient-to-r ui-from-brand-red ui-to-brand-blue ui-text-[#6b7280]'
    >
